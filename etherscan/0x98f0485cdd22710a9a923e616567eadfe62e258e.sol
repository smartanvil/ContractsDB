contract TradeFinancing{
	...
	modifier onlyExporter { if(msg.sender == exporter ) _; }	modifier onlyImporter { if(msg.sender == importer ) _; }	modifier onlyExportsBank { if(msg.sender == exporterBanker ) _; }	modifier onlyImportersBank { if(msg.sender == importerBanker ) _; }
